 ...
 */	
     ...
     * //suppresion
	    ...
	    // methode supprimer concert
	    public static void ConcertSupprimer (String nomt){
    	try{
    		Connection cnx = ConnecterDB();
    		boolean bulle = false;
    		bulle = verifsup(nomt,"concert");
       	   	if (bulle == true){
	   			String sql = "DELETE FROM `concert` WHERE `nom`='"+nomt+"'";
	   			Statement sts = cnx.createStatement();
	   			sts.executeUpdate(sql);
	   			nomt = convertString(nomt);
	   			System.out.println("concert "+nomt+" supprimé");
	   		}
	   		else{
	   			nomt = convertString(nomt);
	   			System.out.println("L'entrée "+nomt+" n'existe pas dans la base");
	    ...
	    // méthode suppresion scene
	    public static void SceneSupprimer (String nomt){	
	    try{
	    	Connection cnx = ConnecterDB();
    		boolean bulle = false;
    		bulle = verifsup(nomt,"scene");
       	   	if (bulle == true){
	   			String sql = "DELETE FROM `scene` WHERE `nom`='"+nomt+"'";
	   			Statement sts = cnx.createStatement();
	   			sts.executeUpdate(sql);
	   			nomt = convertString(nomt);
	   			System.out.println("Scene"+nomt+" supprimée");
	   		}
	   		else{
	   			nomt = convertString(nomt);
	   			System.out.println("L'entrée "+nomt+" n'existe pas dans la base");
	    ...
	    // méthode suppression staff
	    public static void staffSupprimer (String nomt){
	    try{
	    	Connection cnx = ConnecterDB();
    		boolean bulle = false;
    		bulle = verifsup(nomt,"staff");
       	   	if (bulle == true){
	   			String sql = "DELETE FROM `staff` WHERE `nom`='"+nomt+"'";
	   			Statement sts = cnx.createStatement();
	   			sts.executeUpdate(sql);
	   			nomt = convertString(nomt);
	   			System.out.println("staff "+nomt+" supprimé");
	   		}
	   		else{
	   			nomt = convertString(nomt);
	   			System.out.println("L'entrée "+nomt+" n'existe pas dans la base");
	    ...
	    // methode supprimer securite 
	    public static void securiteSupprimer (String nomt){	
   	 	try{
   	 	Connection cnx = ConnecterDB();
		boolean bulle = false;
		bulle = verifsup(nomt,"securite");
			if (bulle == true){
				String sql = "DELETE FROM `securite` WHERE `nom`='"+nomt+"'";
				Statement sts = cnx.createStatement();
				sts.executeUpdate(sql);
				nomt = convertString(nomt);
				System.out.println("securite "+nomt+" supprimé");
			}
			else{
				nomt = convertString(nomt);
					System.out.println("L'entrée "+nomt+" n'existe pas dans la base");
	    ...
	    // methode supprimer spectateur 
	    public static void SpectateurSupprimer (String nom){
   	 	try{
   	 		Connection cnx = ConnecterDB();
   	 		boolean bulle = false;
   	 		bulle = verifsup(nom,"spectateur");
   	 		if (bulle == true){
   	 			String sql = "DELETE FROM `spectateur` WHERE `nom`='"+nom+"'";
   	 			Statement sts = cnx.createStatement();
   	 			sts.executeUpdate(sql);
   	 			nom = convertString(nom);
   	 			System.out.println("spectateur "+nom+" supprimé");
   	 		}
   	 		else{
   	 			nom = convertString(nom);
   	 			System.out.println("L'entrée "+nom+" n'existe pas dans la base");
	    ...
	    // methode supprimer technicien
	    public static void technicienSupprimer (String nom){
	    	
	    	try{
	    		Connection cnx = ConnecterDB();
	    		boolean bulle = false;
	    		bulle = verifsup(nom,"technicien");
	       	   	if (bulle == true){
    	   			String sql = "DELETE FROM `technicien` WHERE `nom`='"+nom+"'";
    	   			Statement sts = cnx.createStatement();
    	   			sts.executeUpdate(sql);
    	   			nom = convertString(nom);
    	   			System.out.println("technicien "+nom+" supprimé");
    	   		}
    	   		else{
    	   			nom = convertString(nom);
    	   			System.out.println("L'entrée "+nom+" n'existe pas dans la base");
	    ...
	    // méthode suppression Commerce
	    public static void CommerceSupprimer (String nom){
	    	
	    	try{
	    		Connection cnx = ConnecterDB();
	    		boolean bulle = false;
	    		bulle = verifsup(nom,"commerce");
	       	   	if (bulle == true){
    	   			String sql = "DELETE FROM `artiste` WHERE `nom`='"+nom+"'";
    	   			Statement sts = cnx.createStatement();
    	   			sts.executeUpdate(sql);
    	   			nom = convertString(nom);
    	   			System.out.println("commerce "+nom+" supprimé");
    	   		}
    	   		else{
    	   			nom = convertString(nom);
    	   			System.out.println("L'entrée "+nom+" n'existe pas dans la base");
